...
function new(arg)
    ...
    local menu = {
        ...
        { "Développement", programs["Development"], utils.lookup_icon({ icon = 'applications-development.png' }) },
        { "Éducation", programs["Education"], utils.lookup_icon({ icon = 'applications-science.png' }) },
        { "Jeux", programs["Game"], utils.lookup_icon({ icon = 'applications-games.png' }) },
        { "Graphisme", programs["Graphics"], utils.lookup_icon({ icon = 'applications-graphics.png' }) },
        ...
        { "==========", {}, utils.lookup_icon({ icon = 'preferences-desktop.png' }) },
        { "Configuration", programs["Settings"], utils.lookup_icon({ icon = 'preferences-desktop.png' }) },
        { "Outils Système", programs["System"], utils.lookup_icon({ icon = 'applications-system.png' }) },
    }
